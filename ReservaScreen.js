      ...
      <View style={mstyles.overlay}>
        <View style={mstyles.box}>
          ...
          <Text style={mstyles.hint}>
            Busca tu cita con tu nombre y opcionalmente tu número.
          </Text>
          ...
          <ScrollView style={{ maxHeight: 260 }}>
            {buscado && !loading && citas.length === 0 && (
              <View style={mstyles.emptyBox}>
                <Text
                  style={{ color: MUTED, textAlign: "center", fontSize: 13 }}
                >
            ...
            {citas.map((c) => (
              <View key={c.id} style={mstyles.citaRow}>
                <View style={{ flex: 1 }}>
                  ...
                  <Text style={mstyles.citaMeta}>{c.barberos?.nombre}</Text>
          ...
          <TouchableOpacity
            style={[mstyles.btnCerrar, { marginTop: 12 }]}
            onPress={cerrar}
          >
      ...
      <SafeAreaView style={styles.page}>
        <View style={styles.successBox}>
          ...
          <Text style={styles.successSub}>
            {barbero?.nombre} · {hora} hrs
          </Text>
          <TouchableOpacity
            style={[styles.btnGold, { marginTop: 32 }]}
            onPress={reset}
          >
            ...
            <View style={styles.barberGrid}>
              {barberos.map((b) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.barberCard,
                    barbero?.id === b.id && styles.barberCardSelected,
                  ]}
                  onPress={() => {
                    setBarbero(b);
                    setFecha(null);
            ...
            >
              {dias.map((d) => (
                <TouchableOpacity
                  ...
                  style={[
                    styles.dateChip,
                    fecha === d.date && styles.dateChipSelected,
                  ]}
                  onPress={() => {
                    setFecha(d.date);
                    setHora(null);
                        ...
                        {slots.map((s) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              {taken && (
                                <Text style={styles.slotLabel}>ocupado</Text>
                              )}
                              {blocked && (
                                <Text
                                  style={[
            ...
            <View style={styles.navBtns}>
              ...
              <TouchableOpacity
                style={[
                  styles.btnGold,
                  { flex: 1, marginLeft: 10 },
                  !nombre.trim() && styles.btnDisabled,
                ]}
                onPress={() => setStep(3)}
        ...
        {step === 3 && (
          <View>
            ...
            <View style={styles.summaryCard}>
              <Text
                style={[styles.formLabel, { marginBottom: 8, marginTop: 4 }]}
              >
                📍 NUESTRA UBICACIÓN
              </Text>
              <MapView
